...
/* Helpers */
function getDefaultExportFunction(source) {
...
function createEmptyReactComponentAst(funName) {
...
function createEmptyReactComponentSource(funName) {
  const sourceFile = ts.createSourceFile(
      `${funName}.tsx`, // Filename
      "",    // Source code
      ts.ScriptTarget.Latest
  );
